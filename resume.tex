...
{+1-240-696-2545 $\bullet$ pburkholder@pobox.com  $\bullet$ http://www.pburkholder.com/ $\bullet$ Twitter: @pburkholder \linebreak GitHub: https://github.com/pburkholder $\bullet$ LinkedIn: http://linkedin.com/in/pburkholder }

\centeredheader{DEVOPS $\bullet$ WEB ENGINEER $\bullet$ CONFIGURATION MANAGEMENT $\bullet$ AWS}
Operations leadership for agile development (Kanban/Scrum) from product planning to continuous release. Expertise includes AWS cloud computing, capacity planning, configuration management, monitoring, version control, continuous delivery, scripted deployments, security and incident management. 

%\header{Achievements}
\smallskip
\vspace*{16pt}

\employer{Rally Health (previously known as Audax Health), Washington, DC}{2012-present}{Cloud/Devops Engineer}
\begin{achievements}
  \item Configuration management and operation of \emph{Zensey}, a HIPAA-compliant on-line health and wellness platform
