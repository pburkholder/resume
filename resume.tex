...
\centeredheader{DEVOPS $\bullet$ CLOUD ENGINEER $\bullet$ AUTOMATION $\bullet$ CYBERSECURITY}
  DevOps leadership and expertise for lean organizations including sales engineering, continuous delivery, 
  security/compliance, cloud computing, configuration management, monitoring, and incident management.
...
\begin{achievements}
  ...
  \item Entire tenure: Served on 18F security working group, co-led DevOps (DevSecOps) guild, spoke at local 
  and national events on cloud adoption and securing cloud platforms, kept customers abreast of 
