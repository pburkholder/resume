...
\begin{achievements}
   \item Operations leadership through product life cycle from planning to continuous release. Expertise includes AWS cloud computing, capacity planning, configuration management, monitoring, version control, continuous delivery, Agile development (Kanban & Scrum), scripted deployments, and incident management.
\end{achievements}
...
\begin{achievements}
  \item Operated over 220 nodes in AWS EC2 under HIPAA-compliance to support on-line health and wellness platform
  \item Designed and wrote Ruby-based zero-downtime release system to shift load-balanced (HAProxy and AWS ELB) traffic between versions of application code
  ...
  \item Enhanced company's community standing by organizing and DevOpsDC MeetUps. Inaugurated company's Engineering Blog in 2012.
\end{achievements}
...
System Administrator and Web Engineer with a focus on bringing rigor and security to the use of open source software. I would like to continue building web infrastructure, from inception to production, in conjunction with development teams and stakeholders.

Operations team lead in agile (Kanban/Scrum) development environments.

Specialties: cloud computing, web engineering, system administration, development support, change and configuration management, monitoring and alerting, capacity planning, revision control systems, IT security, policy and planning.


Configuration management and operation of a HIPAA-compliant social network platform: Zensey. Operated multiple development, test, and partner-integration environments in AWS EC2 configured with Chef to run identically in each environment. Designed and deployed core infrastructure to support application deployment and monitoring across the hundreds of EC2 nodes.

Tools included: Puppet, Chef, MongoDB, RabbitMQ, Redis, Sensu, Graphite, Logstash, Elasticsearch, Jenkins, packaging (FPM, Deb), HAproxy, MySQL.

Wrote or customized tools for specific needs in Ruby, Python and shell. 

Mastered much of the AWS ecosystem: EC2, ELB, EBS, IAM, ASG (autoscaling), RDS, Route 53, Cloudwatch, and so on.

Engaged in community-building and outreach by co-organizing DevOpsDC Meetups.

December 2008 – February 2012 (3 years 3 months)

Deployed open-source Nagios monitoring as alternative to commercial monitoring service, saving client \$100k per year.

Implemented open-source directory services(OpenLDAP) and configuration management (Puppet), doubling our ability to manage change with less downtime.

Automated application deployments, reducing errors to near zero, and reducing deployment time by 75\%

Saved client \$400k by introducing options to a commercial real-user monitoring system to produce the required business intelligence

Reduced time to identify application issues through implementation of NewRelic, allowing developers to isolate issues in minutes instead of hours
