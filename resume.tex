...
\contact{Peter D. Burkholder}
  ...
  {+1-301-204-5767 $\bullet$ pburkholder@pobox.com  $\bullet$ https://github.com/pburkholder
    \linebreak Twitter: @pburkholder $\bullet$ LinkedIn: https://linkedin.com/in/pburkholder 
    \linebreak This résumé: a GitHub project since 2010 at https://github.com/pburkholder/resume}

\centeredheader{CYBERSECURITY $\bullet$ DEVOPS $\bullet$ CLOUD ENGINEER $\bullet$ AUTOMATION}
  Web application and infrastructure architecture expertise for 
  agile/lean organizations including continuous integration and 
  deployment, test-driven development, cloud computing, and incident management.
...
\begin{achievements}
  \item Engineer / Compliance Lead for cloud.gov: Led FedRAMP annual reassessment, managed continuing compliance, POA\&M remediation, and monthly continuous monitoring reporting. Developed engineering and security tools, including ‘caulking’ and ‘cg-audit’, with a cross-functional team of engineers, designers, and product managers. Established test-driven development for compliance requirements, managed projects and all code in GitHub. Guided and customer stakeholders on understanding compliance and improving security stance. Led sales and outreach through workshops, panels and keynote addresses. 

  \item Guided stakeholders at client agencies on cybersecurity and compliance in cloud adoption, translated functional requirements into technical projects on cloud.gov and Azure with version-controlled code. Introduced GitHub and open-source development practices. Developed cloud migration plans for legacy systems. 

 \item \textbf{Key Technologies}: GitHub, Cloud Foundry, Terraform, Kubernetes, 
...
\begin{achievements}
  ...
  \item Published project and continuous delivery code on GitHub in GovReady's org
\end{achievements}
...
%  \item Assured consistency of IT security tooling and compliance status at enterprise customers by deploying Chef Automation and Chef Compliance products.
  \item Worked with cross-functional teams in development, security and operations at customer sites to master test-driven development and continuous integration/deployment tools with code in Git/GitHub.
...
%  \item Conducted the Chef DevOps Journey Assessment (Dojo) with three customers, generated specific one-year recommendations for accelerating delivery of business value with DevOps.
  \item Architected Chef web-application customer deployments for scale, reliability and security with up to 10,000 nodes distributed across multiple data centers.
  \item Developed Chef cookbook products on GitHub with code, plugins, bug fixes and product feature enhancements on behalf of Chef customers.
  \item Acted as liaison between customers and Chef product and engineering teams to assess opportunities in new feature development.
...
%%  \item Ensured compliance with HIPAA regulations for online wellness platform by deploying security tooling and automation.
  \item Developed operational infrastructure for complex HIPAA-compliant web application with team of engineers, compliance expert and product managers 
%  \item Configuration management and operation of \emph{RallyHealth}, a HIPAA-compliant on-line health and wellness platform
 ...
 \item Supported Jenkins for test-driven development and continuous integration and deployment to development and staging environments.
  \item Tools included: Git and GitHub, Puppet, Chef, MongoDB, RabbitMQ, Redis, Sensu, Graphite, Logstash, Elasticsearch, Jenkins, packaging (FPM, Deb), HAproxy, MySQL.
...
\begin{achievements}
  \item Operated web application environment, including application, database and development machines to serve 3 million pages/day for AARP.org, the United State's largest membership organization.
%  \item Led team of four system administrators in Scrum-style approach to work management.
  \item Worked across teams of engineers, designers, product leads and business stakeholders to deliver end-user products and internal tools.
...
\begin{achievements}
   \item Co-managed over 20 web applications for the U.S. government's busiest web site (http://ncbi.nlm.nih.gov, PubMed, MedLine) using CfEngine and Subversion.
...
%   \item Worked with developers to resolve application issues.  Wrote custom extensions for Jira in JRuby and Ruby.  Customized RT3 ticket system in Perl/Catalyst.
   \item Introduced SVK, a distributed version-control system that was a predecessor to Git/GitHub.
\end{achievements}
...
\begin{achievements}
  \item Operated Drupal-based web application systems for two dozen clients of Internet strategy firm.
...
\begin{achievements}
  \item With a team of Java engineers, educational content experts, and XML designers, built a digital library web application for educators in the earth sciences, winner of the UCAR 2003 Outstanding Accomplishment Award for Education and Outreach.
...
\item ``Ruby Test-Driven Development for Chef Cookbooks," DC-Ruby Users Group, May, 2016
...
\item ``Diversifying DevOps Workshop," One-day workshop on infrastructure automation, testing and continuous delivery with Chef, GitHub, AWS and Jenkins. May 2015.
